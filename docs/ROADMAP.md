...
| GR00T-H-N1.7 fine-tune on TUM SonATA Franka | Loss 1.62 → 0.026; checkpoint-15000 uploaded |
...
| Item | Notes |
|------|-------|
| GR00T-H-N1.7 fine-tune — final weights | Training at ~80%, step ~16k/20k; ETA ~5h |
| Demo video script (Level 1+2) | `07_demo_video.py` — 3-camera playback + pred vs GT + 3D EEF trajectory |
...
| Quantitative evaluation on test split | Medium | MSE / L1 on predicted vs GT EEF poses; fill `eval/` directory |
...
_Last updated: 2026-06-03. Move items by editing this file._
